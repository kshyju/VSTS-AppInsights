define(["require", "exports"], function (require, exports) {
    "use strict";
    var AppInsightsWidgetConfiguration = (function () {
        function AppInsightsWidgetConfiguration(WidgetHelpers) {
            this.WidgetHelpers = WidgetHelpers;
            this.$appIdTxt = $("#appId");
            this.$apiKeyTxt = $("#apiKey");
        }
        AppInsightsWidgetConfiguration.prototype.load = function (widgetSettings, widgetConfigurationContext) {
            var _this = this;
        ...
        AppInsightsWidgetConfiguration.prototype.onSave = function () {
            var _this = this;
        ...
        return AppInsightsWidgetConfiguration;
    }());
    exports.AppInsightsWidgetConfiguration = AppInsightsWidgetConfiguration;
